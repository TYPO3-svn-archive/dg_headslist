...
t3lib_extMgm::addPlugin(array(
	'LLL:EXT:dg_headslist/locallang_db.xml:tt_content.list_type_pi1',
	$_EXTKEY.'_pi1',
	t3lib_extMgm::extRelPath($_EXTKEY) . 'ext_icon.gif'
),'list_type');


t3lib_extMgm::addStaticFile($_EXTKEY,"static/heads_list/","heads list");
...
include_once(t3lib_extMgm::extPath($_EXTKEY).'class.tx_dgheadslist_addGroupsToFlexForm.php');
